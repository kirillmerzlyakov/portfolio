...
export const Chicaga: React.FC = () => (
  <div className={cn.projectsContent}>
    <Menu
      ...
      description={
        <span>
          Современная онлайн-платформа с&nbsp;большим выбором обучающих программ
          для изучения английского языка по&nbsp;Skype, Zoom и&nbsp;Webinar,
          а&nbsp;также в&nbsp;офлайн-школах Санкт-Петербурга.
        </span>
      }
