...
export const Brics: React.FC = () => (
  <div className={cn.projectsContent}>
    <Menu
      ...
      description={
        <span>
          Сайт международного центра конкурентного права и&nbsp;политики БРИКС
          в&nbsp;Высшей школе экономики. Проект выполнен в&nbsp;виде постоянно
          обновляющегося журнала, в&nbsp;который авторы подгружают материалы
          англоязычных докладов, новости, видео и&nbsp;документацию.
        </span>
      }
