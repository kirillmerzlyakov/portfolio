  ...
  return (
    <div className={cn.projectsContent}>
      <Menu
        ...
        description={
          <span>
            Онлайн-редактор Скиньскан позволяет подписывать документы
            в&nbsp;форматах doc, pdf, jpg, png в&nbsp;один клик. Просто
            загрузите документ и&nbsp;скан или фото подписи и&nbsp;печати.
            Загрузи документ. PDF, Word, Excel, скан или даже фото! Удали лишние
            и&nbsp;добавь нужные страницы. Добавь подпись и&nbsp;печать.
          </span>
        }
